...
<table width=500 border=1>
   ...
   <td>$dt[saudara]</td>
   <td>$jumlah</td>
   <td><center>$nor1</center></td>
   <td><center>$nor2</center></td>
   <td><center>$nor3</center></td>
   <td>$poin</td>
  </tr>";
        $no++;
    }
...
<tr>
   <td colspan=6></td>
   <td><strong><center>$bobot[0]</center></strong></td>
   <td><strong>$bobot[1]</strong></td>
   <td><strong><center>$bobot[2]</center></strong></td>
 </tr>
";
    echo "</table>";
